...
root.configure(bg="#323D50")
root.option_add("*Font", "Arial 16")



# Source Folder Input.
tk.Label(root, text="Source Folder (camera files):", bg="#323D50").grid(row=0, column=0, padx=5, pady=5, sticky="w")
source_entry = tk.Entry(root, width=50)
source_entry.grid(row=0, column=1, padx=5, pady=5)
browse_source_btn = CustomButton(root, text="Browse", command=lambda: browse_folder(source_entry), width=80, height=30, bg="#384C6F", fg="#c8c8c8", activebg="#0b5ed7", activefg="#c8c8c8")
browse_source_btn.grid(row=0, column=2, padx=5, pady=5)

# Destination Folder Input.
tk.Label(root, text="Destination Folder (JSON files):", bg="#323D50").grid(row=1, column=0, padx=5, pady=5, sticky="w")
dest_entry = tk.Entry(root, width=50)
dest_entry.grid(row=1, column=1, padx=5, pady=5)
browse_dest_btn = CustomButton(root, text="Browse", command=lambda: browse_folder(dest_entry), width=80, height=30, bg="#384C6F", fg="#c8c8c8", activebg="#0b5ed7", activefg="#c8c8c8")
browse_dest_btn.grid(row=1, column=2, padx=5, pady=5)

# Camera Brand Dropdown using CustomDropdown.
tk.Label(root, text="Camera Brand:", bg="#323D50").grid(row=2, column=0, padx=5, pady=5, sticky="w")
...
extensions_label.config(bg="#323D50")

# Process Files Button.
process_btn = CustomButton(root, text="Search & Process Files", command=process_files, width=160, height=30, bg="#274F95", fg="#c8c8c8", activebg="#0b5ed7", activefg="#c8c8c8")
