...
found_files_text = tk.Text(files_frame, wrap="word", height=10, bg="#282828", fg="#C9C9C9", highlightbackground="#282828",  relief="flat", borderwidth=2, highlightthickness=2)
found_files_text.pack(side=tk.LEFT, fill=tk.BOTH, expand=True)

# Define a custom style for the scrollbar.
style = ttk.Style()
#style.theme_use('default')  # Use a base theme; you can choose others as well.
style.theme_use("clam")

style.configure("Custom.Vertical.TScrollbar",
                background="#282828",     # Color of the scrollbar trough
                troughcolor="#282828",      # Color of the trough area (if supported)
                arrowcolor="#282828",       # Color of the arrows
                bordercolor="#282828",
                lightcolor="#282828",
                darkcolor="#282828")

#print(style.layout("Vertical.TScrollbar"))
for s in style.element_options("Horizontal.TScrollbar.trough"):
    print(s)
#print(style.element_options("Horizontal.TScrollbar.thumb"))

# Create a ttk.Scrollbar using the custom style.
scrollbar = ttk.Scrollbar(files_frame, orient="vertical", command=found_files_text.yview, style="Custom.Vertical.TScrollbar")
